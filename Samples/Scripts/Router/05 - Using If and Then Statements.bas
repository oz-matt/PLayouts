...
' 
' This sample demonstrates how to use the If, Then Else Visual Basic keywords.
'
...
' sample also shows an extended version of the MsgBox Visual Basic function.
'
' For more details, please refer to the PADS Layout Visual Basic Editor Help File.
'
Sub Main
	message = "Hi, how are you? Do you like this Visual Basic stuff?"
