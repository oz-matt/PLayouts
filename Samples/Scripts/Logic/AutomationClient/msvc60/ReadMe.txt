...
========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : oleapp
========================================================================


AppWizard has created this oleapp application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your oleapp application.

oleapp.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    COleappApp application class.
...
res\oleapp.ico
    ...
    icon is included by the main resource file oleapp.rc.
...
oleappDlg.h, oleappDlg.cpp - the dialog
    These files contain your COleappDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in oleapp.rc, which can be edited in Microsoft
	Developer Studio.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your COleappDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named oleapp.pch and a precompiled types file named StdAfx.obj.
